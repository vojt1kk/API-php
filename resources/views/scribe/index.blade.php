...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "http://api-php.test";
        var useCsrf = Boolean();
...
<aside>
    <strong>Base URL</strong>: <code>http://api-php.test</code>
</aside>
...
<pre><code>Getting the list of the categories</code></pre>
...
<div class="bash-example">
    ...
    --get "http://api-php.test/api/categories" \
...
<div class="javascript-example">
    ...
    "http://api-php.test/api/categories"
);
...
<div class="bash-example">
    ...
    --form "photo=@/private/var/folders/kn/h8bg5bfn3gb2zvs2dsgv5tr00000gn/T/php3osdg5p6ubo8dlLYUrn" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Example: <code>/private/var/folders/kn/h8bg5bfn3gb2zvs2dsgv5tr00000gn/T/php3osdg5p6ubo8dlLYUrn</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://api-php.test/api/categories/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://api-php.test/api/categories/1"
);
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --form "name=architecto"\
    --form "photo=@/private/var/folders/kn/h8bg5bfn3gb2zvs2dsgv5tr00000gn/T/phpt1ku34s4r74j2sTLkr4" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Example: <code>/private/var/folders/kn/h8bg5bfn3gb2zvs2dsgv5tr00000gn/T/phpt1ku34s4r74j2sTLkr4</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://api-php.test/api/user" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://api-php.test/api/products" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://api-php.test/api/products"
);
